...
This folder contains a ready-to-run Python server. You do not need to change the code. Deploy it directly from the source code by running the following command in the Cloud Shell:
...
## Step 3: Connect the Tool in Agent Studio
